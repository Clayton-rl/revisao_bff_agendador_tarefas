...
public class UsuarioController {
    ...
    @Operation(summary = "Busca Endereço Pelo Cep", description = "Busca dados de endereços recebendo um cep")
    @ApiResponse(responseCode = "200", description = "Dados de endereço retornados com sucesso")
    @ApiResponse(responseCode = "400", description = "Cep inválido")
    @ApiResponse(responseCode = "500", description = "Erro de servidor")
    public ResponseEntity<ViaCepDTOResponse> buscaDadosPorCep(@PathVariable("cep") String cep) {
        return ResponseEntity.ok(usuarioService.buscaDadosPorCep(cep));
    }
}
